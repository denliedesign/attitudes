...
<div class="d-lg-none d-flex justify-content-center pt-3 bg-white">
    <a class="navbar-brand" href="/"><img src="/images/logo-aim.png" alt="" style="max-width: 257px;"></a>
</div>
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 align-items-center">
                <li class="d-none d-lg-block nav-item">
                    <a class="nav-link" href="/">
                        <img src="/images/logo-aim.png" alt="" style="max-width: 257px;">
                    </a>
                </li>
...
{{--                <li class="nav-item mx-1 text-uppercase"><a class="nav-link" href="/">styles</a></li>--}}
{{--                <li class="nav-item mx-1 text-uppercase"><a class="nav-link" href="/">competition</a></li>--}}
{{--                <li class="nav-item mx-1 text-uppercase"><a class="nav-link" href="/">dress code</a></li>--}}
{{--                <li class="nav-item mx-1 text-uppercase"><a class="nav-link" href="/">parties</a></li>--}}
