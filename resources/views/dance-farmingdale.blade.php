@extends('layouts.app')
@section('title', 'Dance Farmingdale | Attitudes in Motion')
@section('description', '')
@section('content')
    ...
    <div class="banner-wrap d-block" style="position: relative;">
        <div class="banner-farmingdale"></div>
    ...
    <div class="bg-white">
        <div class="container pb-5 pt-3">
            <h3 class="font-staat text-center" style="font-size: 100px; line-height: 0.9em;">Dance Farmingdale</h3>
